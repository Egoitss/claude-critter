# Task 7 — `Gauge.swift` source

[← Phase 3](2026-07-08-shaft-redesign-phase3.md). Create this file verbatim
as `Sources/SHAFTCore/Gauge.swift`.
...
`draw` is 26 lines (≤50). All lines ≤80 cols.
